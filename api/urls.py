...
urlpatterns = [
    ...
    path('deleted-users/', views.list_deleted_users, name='list_deleted_users'),
    path('deleted-users/<int:user_id>/restore/', views.restore_deleted_user, name='restore_deleted_user'),
    path('deleted-users/<int:user_id>/delete/', views.delete_user_permanent, name='delete_user_permanent'),
   ...
   # FOLDERS
    ...
    # Admin Archives
    path('admin-archives/', views.list_archived_folders, name='list_archived_folders'),
    path('admin-archives/<int:folder_id>/restore/', views.restore_archived_folder, name='restore_archived_folder'),
    path('admin-archives/<int:folder_id>/delete/', views.delete_archived_folder, name='delete_archived_folder'),

...
Cliquez sur les chiffres pour voir le détail dans un mini-modal.`,
  ...
  {
    icon: "🏢",
    title: "Stats de mon service",
    content: `Cliquez sur 📊 dans la barre supérieure pour accéder aux statistiques de votre service.

2 onglets disponibles :

🏢 Mon service :
- Membres du service (total, en ligne, connectés/absents aujourd'hui) — cliquez sur les chiffres pour voir les noms
- Dossiers du service (partagés vs privés)
- Fichiers du service (total + taille)
- Activité équipe des 7 derniers jours
...
export default HelpModalResponsable;

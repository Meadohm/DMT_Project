        ...
        {activeSection === "dashboard" && (
          <>
            ...
            <div className="dashboard-grid">
              ...
              <div className="dashboard-card dashboard-card-deleted-users" onClick={() => { setActiveSection("deleted-users"); fetchDeletedUsers(); }}>
                <div className="dashboard-card-icon">👤</div>
                <div className="dashboard-card-content">
                  <h3>Comptes supprimés</h3>
                  <div className="dashboard-card-main">{dashboardStats?.deleted_users?.total ?? 0}</div>
                  <div className="dashboard-card-details">
                    <span className={`dash-detail${(dashboardStats?.deleted_users?.total ?? 0) > 0 ? " inactive" : ""}`}>
                      {(dashboardStats?.deleted_users?.total ?? 0) > 0 ? "⚠️ À traiter" : "✅ Aucun"}
                    </span>
                  </div>
                </div>
                <div className="dashboard-card-arrow">→</div>
